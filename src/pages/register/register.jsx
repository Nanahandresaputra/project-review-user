...
const Register = () => {
  ...
  return (
    <section className='my-32 md:my-0 mx-5 md:mx-0 md:h-screen flex justify-center items-center'>
      <div className='flex justify-center lg:grid lg:grid-cols-2  items-cente w-10/12'>
        <div className='hidden lg:flex justify-center items-center'>
          <img
            ...
            className='lg:w-[450px] lg:h-[530px] 2xl:w-[500px] 2xl:h-[560px]'
          />
        </div>
        ...
        <div className='flex flex-col justify-center items-center space-y-3 md:space-y-5 lg:mt-8 2xl:mt-0'>
          ...
          <form
            ...
            className='border shadow- p-5 flex flex-col space-y-5 md:w-[700px] lg:w-[600px]'
          >
